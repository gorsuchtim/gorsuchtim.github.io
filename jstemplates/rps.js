        ...
        switch (card) {
            case 2:
                ...
                if (result === 'Tie') {
                    ...
                    round1Result = 'the AI wins this round';
                }
                $('.tooltip__text').html('Looks like ' + round1Result + '.  Click Continue below to advance to the next page.');
                $('.continueWalkthrough').addClass('highlightContinue pulse');
                break;
            case 3:
                tutorialCard = 3;
                $('.tooltip__text').html('Since no data is available, the AIs choice of ' + compChoice + ' is random.  Click Continue to advance to Round ' + (round + 1) + '.');
                break;
            case 4:
                tutorialCard = 4;
