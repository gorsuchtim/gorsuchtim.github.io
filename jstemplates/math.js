$(document).ready(function () {
    ...
    function prepNextLevel() {
        ...
        $('.ring:not(.ring1)').css('opacity', '0').removeClass('dynamicBorderColor'); // remove all appended rings except ring1 (which contains the timer html)
